...
rem  required by Auto_Centerline.pyt inside ArcGIS Pro.
rem
...
rem    cd to the auto_centerline folder and run:
rem      install_dependencies.bat
rem
rem  Option B:
...
rem    2. conda create --name arcgispro-py3-auto --clone arcgispro-py3
rem    3. activate arcgispro-py3-auto
rem    4. Re-run this script.
rem    5. In ArcGIS Pro: Project > Python > Python Environments
rem       Select "arcgispro-py3-auto" and restart ArcGIS Pro.
rem ============================================================

setlocal

echo ============================================================
echo  Auto Centerline -- Dependency Installer
echo ============================================================
echo.
...
if errorlevel 1 (
    ...
    echo   conda create --name arcgispro-py3-auto --clone arcgispro-py3
    echo   activate arcgispro-py3-auto
...
echo  You can now run the Auto Centerline toolbox in ArcGIS Pro.
echo ============================================================
echo.
pause
exit /b 0
...
echo.
echo ============================================================
echo  Installation incomplete.  See: auto_centerline/README.md
echo ============================================================
echo.
pause
exit /b 1
