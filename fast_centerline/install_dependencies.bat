...
rem  required by Fast_Centerline.pyt inside ArcGIS Pro.
rem
...
rem    cd to the fast_centerline folder and run:
rem      install_dependencies.bat
rem
rem  Option B:
...
rem    2. conda create --name arcgispro-py3-fast --clone arcgispro-py3
rem    3. activate arcgispro-py3-fast
rem    4. Re-run this script.
rem    5. In ArcGIS Pro: Project > Python > Python Environments
rem       Select "arcgispro-py3-fast" and restart ArcGIS Pro.
rem ============================================================

setlocal

echo ============================================================
echo  Fast Centerline -- Dependency Installer
echo ============================================================
echo.
...
if errorlevel 1 (
    ...
    echo   conda create --name arcgispro-py3-fast --clone arcgispro-py3
    echo   activate arcgispro-py3-fast
...
echo  You can now run the Fast Centerline toolbox in ArcGIS Pro.
echo ============================================================
echo.
pause
exit /b 0
...
echo.
echo ============================================================
echo  Installation incomplete.  See: fast_centerline/README.md
echo ============================================================
echo.
pause
exit /b 1
