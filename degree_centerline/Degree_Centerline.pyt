...
skeleton graph into topological segments and filtering noise branches.
...
class PolygonToCenterlineDegree(object):
    ...
    def __init__(self):
        ...
        self.description = (
            ...
            "degree-aware skeleton decomposition (Plan C) that preserves ALL "
            "meaningful branches of the medial-axis graph.\n\n"
            "Unlike the 'Fast' tool which extracts only the single longest path "
            "(losing all branches), this tool decomposes the skeleton graph into "
            "topological segments between junctions and leaf nodes, filters out "
            "short noise branches, and returns a MULTILINESTRING that faithfully "
            "represents the branching centerline.\n\n"
