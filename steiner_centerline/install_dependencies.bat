...
rem  required by Steiner_Centerline.pyt inside ArcGIS Pro.
rem
...
rem    cd to the steiner_centerline folder and run:
rem      install_dependencies.bat
rem
rem  Option B:
...
rem    2. conda create --name arcgispro-py3-steiner --clone arcgispro-py3
rem    3. activate arcgispro-py3-steiner
rem    4. Re-run this script.
rem    5. In ArcGIS Pro: Project > Python > Python Environments
rem       Select "arcgispro-py3-steiner" and restart ArcGIS Pro.
rem ============================================================

setlocal

echo ============================================================
echo  Steiner Centerline -- Dependency Installer
echo ============================================================
echo.
...
if errorlevel 1 (
    ...
    echo   conda create --name arcgispro-py3-steiner --clone arcgispro-py3
    echo   activate arcgispro-py3-steiner
...
echo  You can now run the Steiner Centerline toolbox in ArcGIS Pro.
echo ============================================================
echo.
pause
exit /b 0
...
echo.
echo ============================================================
echo  Installation incomplete.  See: steiner_centerline/README.md
echo ============================================================
echo.
pause
exit /b 1
